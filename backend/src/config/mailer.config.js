...
export const sendProjectMail = async (project) => {
  ...
  `;
    ...
    const mailOptions = {
        ...
        replyTo: project.email,   // Reply will go to the user who submitted
...
export const sendContactMail = async (contact) => {
    ...
    <p><strong>Phone:</strong> ${contact.your_number}</p>
  ...
  `;
    ...
    const mailOptions = {
        ...
        to: AdminEmail,   // Sirf tumhe milega
        subject: `New Contact Request — ${contact.your_name}`,
        replyTo: contact.your_email,   // Agar reply karoge toh user ko jayega
        text: `New contact request from ${contact.your_name} (${contact.your_email})
Phone: ${contact.your_number}
...
export const sendCareerMail = async (career) => {
    ...
    <p><strong>Phone:</strong> ${career.your_number}</p>
